...
* Subtipus
  ...
  * [afixos](): sufixos, prefixos, infixos, circumfixos
...
<span>
<p style='margin-top:1em; text-align:center'>
<b>Llavors, podem concloure que algunes llengües són més complexes que altres? Quins tipus? Per què?</b><br><br><br><br>
<b>Això vol dir també que hi ha llengües que són més difícils d'aprendre?</b><br><br>
Per exemple, moltes vegades "al carrer" es diu que el castellà és més fàcil d'aprendre que l'alemany o el mandarí.<br><br>
<b>Té fonament lingüístic aquesta afirmació?</b>
</p>
</p></span>
</div>
...
Què ve primer *re* o *able*?

--

*re-*: re- + V $\Rightarrow$ V (*rewind*, *revisit*, *redo* but \*rehappy or \*rekitten)

*-able*: V + -able $\Rightarrow$ A (*stoppable*, *doable*, but \*happyable or \*kittenable)

---

# Exemple 2

*unusuable*: un- + use + -able
...
* Practica de morfologia

* Qüestionari de lectura (sintaxi)
